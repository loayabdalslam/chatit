      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              ChatIt: AI Models<br className="hidden sm:inline" />for the MENA Region
            </h1>
            ...
            >
              Advanced digital chatbot solutions and fine-tuned language models for large enterprises and organizations across Egypt and the Middle East.
            </p>
