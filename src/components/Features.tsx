      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            AI Solutions, <br className="hidden sm:block" />Built for Enterprises
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Advanced chatbot technology tailored for the Arabic-speaking market and enterprise needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Arabic Language Models"
            description="Fine-tuned LLMs specifically designed for Arabic language nuances and cultural context in the MENA region."
            index={0}
          />
          <FeatureCard
            ...
            description="Advanced digital chatbot solutions designed for large enterprises and organizations with complex workflows."
            index={1}
          />
          <FeatureCard
            ...
            description="Tailored AI models that understand your business domain, terminology, and specific use cases."
            index={2}
          />
          <FeatureCard
            ...
            description="Deep understanding of MENA market needs with AI solutions specifically for Egyptian and Middle Eastern businesses."
            index={3}
          />
          <FeatureCard
            ...
            description="Backed by Microsoft for Startups, ensuring enterprise-grade security, scalability, and reliability."
            index={4}
          />
          <FeatureCard
            ...
            title="AI Since 2019"
            description="Our team has been working on AI technologies since 2019, bringing years of experience to every solution."
            index={5}
          />
        </div>
      </div>
